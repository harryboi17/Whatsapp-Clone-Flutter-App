...
class AuthController{
  ...
  Stream<UserModel> streamUserDataById(String userId){
    return authRepository.userData(userId);
  }
  Stream<Group> streamGroupDataById(String groupId){
  ...
  void setUserTypingStatus(bool isTyping, String userId, bool isGroupChat){
    authRepository.setUserTyingStatus(isTyping, userId, isGroupChat);
  }
